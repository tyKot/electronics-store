...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Interfaces\PaymentGatewayInterface' => \App\Services\MockPaymentService::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\lara\electronics-store\public\storage' => 'string',
            ...
            'services.botpress.token' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\lara\\electronics-store\\public\\storage','logging.default','logging.deprecations.channel',
...
'mail.markdown.extensions','openai.api_key','openai.organization','openai.project','openai.base_uri',
'openai.request_timeout','permission.models.permission','permission.models.role','permission.models.team','permission.models.default_model',
...
'services.botpress.token','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'session.same_site','session.partitioned','session.serialization','debugbar.enabled','debugbar.collect_jobs',
...
'debugbar.options.db.explain.enabled','debugbar.options.db.show_query_result','debugbar.options.db.only_slow_queries','debugbar.options.db.slow_threshold','debugbar.options.db.memory_usage',
...
'image.driver','image.options.autoOrientation','image.options.decodeAnimation','image.options.backgroundColor','image.options.strip',
'sanctum.stateful','sanctum.guard','sanctum.expiration','sanctum.token_prefix','sanctum.middleware.authenticate_session',
'sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','query-builder.parameters.include','query-builder.parameters.filter','query-builder.parameters.sort',
'query-builder.parameters.fields','query-builder.parameters.append','query-builder.delimiter','query-builder.filter_value_splitting_enabled','query-builder.suffixes.count',
'query-builder.suffixes.exists','query-builder.suffixes.min','query-builder.suffixes.max','query-builder.suffixes.sum','query-builder.suffixes.avg',
'query-builder.disable_invalid_filter_query_exception','query-builder.disable_invalid_sort_query_exception','query-builder.disable_invalid_include_query_exception','query-builder.convert_relation_names_to_snake_case_plural','query-builder.convert_relation_table_name_strategy',
'query-builder.convert_field_names_to_snake_case','sitemap.guzzle_options','sitemap.execute_javascript','sitemap.chrome_binary_path','sitemap.crawl_profile',
...
'signed','throttle','verified','bot.token',);
        registerArgumentsSet('routes', 
'debugbar.openhandler','debugbar.cache.delete','debugbar.queries.explain','debugbar.clockwork','debugbar.assets',
'sanctum.csrf-cookie','dashboard','home','catalog.index',
'products.show','cart.index','checkout.index','checkout.store','admin.dashboard',
'admin.products.index','admin.products.store','admin.products.generate-description','profile.index','profile.update','profile.password','register','login','password.request','password.email',
...
'pagination::simple-tailwind','pagination::tailwind','sitemap::image','sitemap::news','sitemap::sitemap',
'sitemap::sitemapIndex.index','sitemap::sitemapIndex.sitemap','sitemap::url','sitemap::video',);
        registerArgumentsSet('translations', 
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'D:.lara.electronics-store.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','BOTPRESS_API_TOKEN',

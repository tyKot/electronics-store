...
'inertia.testing.ensure_pages_exist','inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','image.driver',
'image.options.autoOrientation','image.options.decodeAnimation','image.options.backgroundColor','image.options.strip','sanctum.stateful',
...
'sanctum.middleware.validate_csrf_token','query-builder.parameters.include','query-builder.parameters.filter','query-builder.parameters.sort','query-builder.parameters.fields',
'query-builder.parameters.append','query-builder.delimiter','query-builder.filter_value_splitting_enabled','query-builder.suffixes.count','query-builder.suffixes.exists',
'query-builder.suffixes.min','query-builder.suffixes.max','query-builder.suffixes.sum','query-builder.suffixes.avg','query-builder.disable_invalid_filter_query_exception',
'query-builder.disable_invalid_sort_query_exception','query-builder.disable_invalid_include_query_exception','query-builder.convert_relation_names_to_snake_case_plural','query-builder.convert_relation_table_name_strategy','query-builder.convert_field_names_to_snake_case',
